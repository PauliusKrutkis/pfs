...
class Paginator
{
    ...
    public function toHtml()
    {
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li><a data-page="' . $this->getPrevUrl() . '" href="#">' . $this->previousText . '</a></li>';
        }

        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li' . ($page['isCurrent'] ? ' class="active"' : '') . '><a data-page="' . $page['url'] . '" href="#">' . $page['num'] . '</a></li>';
            } else {
        ...
        if ($this->getNextUrl()) {
            $html .= '<li><a data-page="' . $this->getNextUrl() . '" href="#">' . $this->nextText . '</a></li>';
        }
        $html .= '</ul>';
